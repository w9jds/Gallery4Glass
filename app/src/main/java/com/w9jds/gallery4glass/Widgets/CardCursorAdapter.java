package com.w9jds.gallery4glass.Widgets;
 ...
 * columns.
 */
public abstract class CardCursorAdapter extends CardScrollAdapter implements Filterable,
     ...
     * you not use this, but instead {@link #CardCursorAdapter(Context, Cursor, int)}.
     ...
     */
    public CardCursorAdapter(Context context, Cursor c, boolean autoRequery) {
